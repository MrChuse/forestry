helper_text = '''Welcome to a demo of my little game about selective breeding!
...
The esc menu also has the Mendelian Inheritance helper window if you are interested in genetics'''.replace('\n', '<br>')

mendel_text = '''This helper window will explain basics of genetics according to Mendelian Inheritance.
...
Oh, by the way, when two bees with different species alleles mate, their offspring may or may not have a mutation chance to transform into the different species'''.replace('\n', '<br>')